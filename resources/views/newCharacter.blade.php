...
@section('content')
    ...
    <div class="view view-starry-night">
        <form class="form-section registration" novalidate="" action="{{url('/new')}}" method="POST">
            @csrf
            ...
            <label data-testid="InputName-wrapper" class="input-text input-text-InputName displayed" for="InputName">
                ...
                <div class="input-wrapper">
                    <input class="input-InputName" type="text" id="name" name="name" placeholder="Name" value="">
                </div>
            </label>
            <label data-testid="InputBirthYear-wrapper" class="input-text input-text-InputBirthYear" for="InputBirthYear">
                ...
                <div class="input-wrapper">
                    <input class="input-InputBirthYear" type="text" id="birth_year" name="birth_year" placeholder="Birth Year" value="">
                </div>
            </label>
            <label data-testid="InputPlanetId-wrapper" class="input-text input-text-InputPlanetId" for="InputPlanetId">
                ...
                <div class="input-wrapper">
                    <input class="input-InputPlanetId" type="number" id="planet_id" name="planet_id" placeholder="Planet Id" value="">
                </div>
            </label>
            <div id="URLPanel" class="url-panel">
                <label class="input-text input-text-url-new" for="url-new">
                    ...
                    <div data-testid="url-new-container" class="input-wrapper">
                        <input class="input-url-new" type="url" id="url" name="url" placeholder="URL" value="">
                    </div>
                </label>
            </div>
