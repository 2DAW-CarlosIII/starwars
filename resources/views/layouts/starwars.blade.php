      ...
      <div id="nav-drawer">
        <nav id="nav-content">
          ...
          <ul id="section-links" itemscope="" itemtype="https://www.schema.org/SiteNavigationElement">
            ...
            <li itemprop="name">
              <a itemprop="url" class="section-link gamesapps-content" href="http://starwars.test"
                data-cto="section" data-section="gamesapps" tabindex="0" aria-hidden="false">
                <p class="gamesapps-content-title"><span>Interactive</span><span class="vertical-bar"></span><span
                    class="horizontal-bar"></span></p>
              </a>
          </ul>
                    ...
                    <div class="module_header">
                      <div class="title">
                        <h2 class="title-container"> <span class="title-text">
                            <div class="mobile-title-text">DESARROLLO ENTORNO SERVIDOR - JUNIO 2022</div>
                            <div class="non-mobile-title-text">DESARROLLO ENTORNO SERVIDOR - JUNIO 2022</div>
                          </span> </h2>
                      </div>
                    </div>
                  </div>
